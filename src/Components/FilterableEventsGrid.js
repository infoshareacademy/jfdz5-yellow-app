...
import EventsGridItem from './EventGridItem'
...
class FilterableEventsGrid extends React.Component {
...
console.log(eventsToShow)
    return (
          ...
          <EventsGrid events={eventsToShow}/>
        </div>
        )
      }
}

export default FilterableEventsGrid
